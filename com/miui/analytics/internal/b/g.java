...
*/
        ...
        r2 = "_id";	 Catch:{ Exception -> 0x0026, all -> 0x0038 }
        ...
        r2 = "reportServiceDB";	 Catch:{ Exception -> 0x0026, all -> 0x0038 }
    ...
    L_0x003e:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.analytics.internal.b.g.a(java.lang.String, java.lang.String):void");
    }
...
*/
        ...
        r0 = "reportServiceDB";	 Catch:{ Exception -> 0x001e, all -> 0x0030 }
        r2 = "_id = ? ";	 Catch:{ Exception -> 0x001e, all -> 0x0030 }
    ...
    L_0x001e:
        r0 = move-exception;
        r2 = "ReportServiceDB";	 Catch:{ Exception -> 0x001e, all -> 0x0030 }
    ...
    L_0x0036:
        throw r0;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.miui.analytics.internal.b.g.b(java.lang.String):void");
    }
    ...
    public String a(String str) {
        ...
        try {
            ...
            try {
                ...
                cursor = readableDatabase.query(c, new String[]{"_id", e}, "_id = ? ", new String[]{str}, null, null, null);
    ...
    public List<Pair<String, String>> a() {
        ...
        try {
            ...
            try {
                readableDatabase.beginTransaction();
                cursor = readableDatabase.query(c, new String[]{"_id", e}, null, null, null, null, null);
                if (cursor == null || !cursor.moveToFirst()) {
                    readableDatabase.setTransactionSuccessful();
                    if (cursor != null) {
                        cursor.close();
                ...
                do {
                    arrayList.add(new Pair(cursor.getString(cursor.getColumnIndexOrThrow("_id")), cursor.getString(cursor.getColumnIndexOrThrow(e))));
